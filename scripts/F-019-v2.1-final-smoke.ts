...
const OUT_DIR_NAME = "F-019-v2.1-final-smoke";

async function main() {
  const t0 = Date.now();
  const breakdown: Record<string, number> = {};

  console.log("[v2.1 smoke] (1/6) generateCarouselScript...");
  ...
  console.log("[v2.1 smoke] (2/6) DALL-E generateImagesForSlides...");
  ...
  console.log("[v2.1 smoke] (3/6) renderCarouselAllVariations (12 PNGs)...");
  ...
  console.log("[v2.1 smoke] (4/6) packCarouselZip...");
  ...
  console.log("[v2.1 smoke] (5/6) upload Supabase Storage...");
  ...
  console.log("[v2.1 smoke] (6/6) saving local copy + extracting PNGs...");
  ...
  const summary = {
    event: "smoke_f019_v2.1_final_complete",
