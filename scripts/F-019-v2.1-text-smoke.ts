 ...
 *   - .preview/F-019-v2.1-json-smoke.json
 *   - .preview/F-019-v2.1-vs-v2.0-comparison.md
 *
...
async function main() {
  ...
  const jsonPath = path.join(outDir, "F-019-v2.1-json-smoke.json");
  const cmpPath = path.join(outDir, "F-019-v2.1-vs-v2.0-comparison.md");
