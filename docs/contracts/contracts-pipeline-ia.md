...
> ⚠️ **PIVOT 2026-04-29 — ver [ADR-005](../decisions/adr/ADR-005-pivot-brevidade-para-artigo-denso-blog.md):** schemas `Briefing*`, `BriefingDraft`, `CommitRequest`, `CommitResponse`, `WeeklyDigestRequest/Response`, `TelegramPostRequest/Response`, `AdminBriefingActionRequest/Response`, `AdminListBriefingsQuery` foram **APAGADOS** na limpeza pós-pivot. Ver `git log` para histórico.
>
...
*Próximo passo: ADRs em `docs/decisions/adr/` para decisões arquiteturais com trade-off real.*
