...
- SPEC `docs/news/SPEC.md` §RNF-008 (proteção autoral Bloomberg), §6.2b (Anti-SPEC), CA-011, CA-012b, CA-014b, CB-017
- CONTRACTS `docs/news/CONTRACTS.md` §1 (FonteCitavel refine), §4 (Perplexity refine)
