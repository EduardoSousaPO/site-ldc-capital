export const TAX_CONSTANTS = {
  ...
  CLUBE_MIN_COTISTAS: 3,
  CLUBE_MAX_COTISTAS: 50,
  CLUBE_VALOR_MINIMO: 1_000_000,
  CLUBE_ACOES_MIN_PERCENTUAL: 67,
  CLUBE_ALIQUOTA_ACOES: 0.15,
  CLUBE_ALIQUOTA_FUNDO_CURTO_PRAZO: 0.225,
  CLUBE_TAXA_MIN_PERCENTUAL: 0.75,
  CLUBE_TAXA_MAX_PERCENTUAL: 1.5,
  CLUBE_TAXA_PADRAO_PERCENTUAL: 0.75,
  CLUBE_CRESCIMENTO_PADRAO_PERCENTUAL: 8,
} as const;
